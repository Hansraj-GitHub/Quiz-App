...
function initApp() {
    ...
    quiz = new Quiz(
        ...
        `Welcome to the Simple JavaScript Quiz! Test your knowledge and have fun with interactive quiz questions. Whether you're a beginner or an expert, this quiz will challenge your skills in an engaging way.`,
        70,
        questions);
